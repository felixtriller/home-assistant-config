...
def setup_platform(hass, config, add_devices, discovery_info=None):
    ...
    dark_sky = DarkSkyDailyData(
        config.get(CONF_API_KEY), latitude, longitude, units)

    add_devices([DarkSkyWeatherDaily(name, dark_sky)], True)


class DarkSkyWeatherDaily(WeatherEntity):
